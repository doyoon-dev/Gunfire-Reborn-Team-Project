...
public class WeaponUI : UI_Scene
{
    GameObject m_grenadeUI;
    public UnityEngine.UI.Image m_grenadeAlpha;
    ...
    [SerializeField]
    GameObject m_currentGunObj;
    UnityEngine.UI.Image[] m_currentGunImages;

    #region 대쉬 UI

    public DashUI m_dashUI;
    ...
    //public int m_maxGreenBullet = 450;
    //public int m_maxBlueBullet = 120;
    //public int m_maxYellowBullet = 30;
    ...
    void Awake()
    {
        ...
        // 대쉬
        m_dashUI = transform.Find("DashUI").GetComponent<DashUI>();
        ...
        m_grenadeAlpha = m_grenadeImage.transform.GetChild(1).gameObject.GetComponent<UnityEngine.UI.Image>();
